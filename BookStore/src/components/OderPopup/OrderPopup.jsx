    ...
    <div className='h-screen w-screen fixed top-0 left-0  z-50 backdrop-blur-sm'>
        ...
        <div className='flex items-center justify-between'>
         ...
         <div className='mt-4'>
            ...
            <input type="text" placeholder='Phone' className='w-full rounded-full border border-gray-300 px-2 py-1 mb-4'/>            
            <input type="text" placeholder='Address' className='w-full rounded-full border border-gray-300 px-2 py-1 mb-4'/>
            <input type="text" placeholder='Book Name' className='w-full rounded-full border border-gray-300 px-2 py-1 mb-4'/>
